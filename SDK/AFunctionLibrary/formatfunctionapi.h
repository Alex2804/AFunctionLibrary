...
#define AFL_REGISTER_FORMAT_FUNCTION_STRING_FEATURE(feature_name, function_string_parameter_name)                      \
    AFL_C_API_REGISTER_FORMAT_FUNCTION_STRING_FEATURE(feature_name, function_string_parameter_name)
#define AFL_C_API_REGISTER_FORMAT_FUNCTION_STRING_FEATURE(feature_name, function_string_parameter_name)                    \
...
#define AFL_CPP_API_REGISTER_FORMAT_FUNCTION_STRING_FEATURE(feature_name, function_string_parameter_name)                  \
